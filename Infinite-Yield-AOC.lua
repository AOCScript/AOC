...
reference = (function()
	local main = create({
		...
		{90,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={84},Position=UDim2.new(0,8,0,98),Size=UDim2.new(1,-8,0,42),Text=";2^btools - gives you 2 sets of btools\n;10^3^drophats - drops your hats every 3 seconds 10 times\n;inf^0.1^animspeed 100 - infinitely loops your animation speed to 100",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
	...
	inviteButton.MouseButton1Click:Connect(function()
		if everyClipboard then
			toClipboard("https://discord.gg/UmQkTjq6jJ")
		...
		Button.Text = "Copy Discord Invite Link (https://discord.gg/UmQkTjq6jJ)"
	end)
	dragGUI(main)
	main.Parent = PARENT
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = ' to the Infinite Yield support server.'}
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/AOCScript/AOC/main/Infinite-Yield-AOC.lua'))()") --original are https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source
	end
end)
...
addcmd('discord', {'support', 'help', '(Original)'}, function(args, speaker)
	if everyClipboard then
		toClipboard('https://discord.com//dYHag43eeU')
		notify('Discord ', 'Copied to clipboard!\ndiscord.gg/dYHag43eeU')
	else
		notify('Discord ', 'discord.gg/dYHag43eeU')
	end
	if httprequest then
		httprequest({
...
task.spawn(function()
	...
	if success then
		if currentVersion ~= latestVersionInfo.Version then
			notify('AOC','Buy AOC monitor NOW🥰')
		end
